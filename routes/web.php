...
Route::get('client', [ClientController::class, 'index'])->middleware(['auth','verified']);
...
Route::get('xerc', [XercController::class, 'index'])->middleware(['auth','verified']);
...
Route::get('employee_document/{id}', [EmployeeDocController::class, 'index'])->middleware(['auth','verified']);
...
Route::get('credit', [CreditController::class, 'index'])->middleware(['auth','verified']);
Route::post('credit_insert', [CreditController::class, 'store']);
Route::post('credit_update', [CreditController::class, 'edit']);
Route::get('pay/{id}', [CreditController::class, 'pay'])->middleware(['auth','verified']);
Route::post('pay_confirm/{id}', [CreditController::class, 'pay_confirm']);
Route::get('pay_check/{id}', [CreditController::class, 'show'])->middleware(['auth','verified']);
Route::post('cancel', [CreditController::class, 'cancel'])->middleware(['auth','verified']);
